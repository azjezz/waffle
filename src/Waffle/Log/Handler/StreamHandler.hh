...
use namespace Waffle\Log\Exception;
...
class StreamHandler extends AbstractHandler
{
     ...
     */
    public function __construct(string $url, LogLevel $level = LogLevel::DEBUG, bool $bubble = true, ?int $filePermission = null, bool $useLocking = false)
    {
