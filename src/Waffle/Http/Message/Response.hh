...
class Response implements ResponseInterface
{
    ...
    public function __construct(int $status = 200, dict<string, vec<string>> $headers = dict[], ?StreamInterface $body = null, string $version = '1.1', ?string $reason = null)
    {
    ...
    public function withStatus(int $code,string $reasonPhrase = ''): this
    {
        ...
        if ('' === $reasonPhrase && C\contains_key(self::$phrases, $new->statusCode)) {
